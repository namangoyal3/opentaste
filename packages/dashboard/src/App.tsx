  ...
  return (
    <div className="app">
        ...
        <section className="quick-actions">
          ...
          <div className="action-grid">
            ...
            <button className="action-card">
              ...
              <span className="action-desc">opentaste.json config</span>
            </button>
            <button className="action-card">
              <span className="action-icon">🔄</span>
      ...
      <footer className="footer">
        <span>OpenTaste v1.0.0</span>
        <a href="https://github.com/namangoyal3/opentaste" target="_blank" rel="noopener noreferrer">GitHub</a>
